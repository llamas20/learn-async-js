...
function animateAlices(alice1, alice2, alice3) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, alice1.animate(aliceTumbling1, aliceTiming1).finished];
                case 1:
                    _a.sent();
                    return [4 /*yield*/, alice2.animate(aliceTumbling1, aliceTiming1).finished];
                case 2:
                    _a.sent();
                    return [4 /*yield*/, alice3.animate(aliceTumbling1, aliceTiming1).finished];
                case 3:
                    _a.sent();
